...
<head>
  ...
  <link rel="stylesheet" href="{{asset('error/normalize.min.css')}}">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <p>Something went wrong on your action. Report us and we will solve soon!!!!</p>
        <p>{{Session::get('message')}}</p>
        <a class="btn green" href="{{url('')}}">HOME</a>
      </div>
    </div>
  </div>
</main>
<!-- partial -->
  <script src='{{asset('error/gsap.min.js')}}'></script>
  <script  src="{{asset('error/404.js')}}"></script>
</body>
</html>
