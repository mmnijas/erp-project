<aside class="control-sidebar control-sidebar-dark" style="top: 57px; height: 253px; display: block;">
    <!-- Control sidebar content goes here -->
    <div class="p-3 control-sidebar-content os-host os-theme-light os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition os-host-overflow os-host-overflow-y" style="height: 253px;">
       ...
       <div class="os-content-glue" style="margin: -16px; width: 249px; height: 252px;"></div>
       ...
       <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
          <div class="os-scrollbar-track">
             <div class="os-scrollbar-handle" style="transform: translate(0px, 0px); height: 19.582%;"></div>
          </div>
       </div>
