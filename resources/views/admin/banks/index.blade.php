...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <button type="button" class="btn btn-primary btn-modal" data-href="{{route('banks.create')}}" data-container=".modal_class">
...
<script >
    $( document ).ready(function() {
        ...
        columns: [
            ...
            {data: 'common_ifsc', name: 'common_ifsc'},
            {data: 'account_number_length', name: 'account_number_length'},
