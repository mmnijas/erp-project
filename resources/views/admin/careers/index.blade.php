...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
              <button type="button" class="btn btn-primary btn-modal" data-href="{{route('careers.create')}}" data-container=".modal_class">
                <i class="fa fa-plus"></i> ADD NEW VACANCY</button>
          </div>
          <div class="col-sm-6">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <form role="form" action="{{url('admin/careers')}}" method="post" id="removeForm">
