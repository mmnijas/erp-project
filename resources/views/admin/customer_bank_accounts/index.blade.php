...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <button type="button" class="btn btn-primary btn-modal" data-href="{{route('customer-bank-accounts.create')}}" data-container=".modal_class">
...
<script >
    $( document ).ready(function() {
        ...
        ajax: {
          url: "{{ route('customer-bank-accounts.index') }}",
          data: function (d) {
