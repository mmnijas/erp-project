...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <button type="button" class="btn btn-primary btn-modal" data-href="{{route('banking-account-ledgers.create')}}" data-container=".modal_class">
...
<script >
    $( document ).ready(function() {
        ...
        ajax: {
          url: "{{ route('banking-account-ledgers.index') }}",
          data: function (d) {
    ...
    $("#bankAccountLedgersNav").addClass('active');
   </script>
