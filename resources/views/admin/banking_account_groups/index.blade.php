...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <button type="button" class="btn btn-primary btn-modal" data-href="{{route('banking-account-groups.create')}}" data-container=".modal_class">
          ...
          <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ACCOUNT GROUPS</h3>
                </div>
                <div class="card-body">
...
<script >
    $( document ).ready(function() {
        ...
        ajax: {
          url: "{{ route('banking-account-groups.index') }}",
          data: function (d) {
    ...
    $("#bankAccountGroupsNav").addClass('active');
   </script>
