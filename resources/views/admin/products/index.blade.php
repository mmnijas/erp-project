...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <a class="btn btn-info pull-right" href="{{route('products.create')}}"><i class="fa fa-plus"></i> ADD NEW PRODUCT</a>
          </div>
          <div class="col-sm-6">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <form role="form" action="{{url('admin/products')}}" method="post" id="removeForm">
