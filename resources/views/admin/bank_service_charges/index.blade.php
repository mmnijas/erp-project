...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <button type="button" class="btn btn-primary btn-modal" data-href="{{route('bank-service-charges.create')}}" data-container=".modal_class">
...
<script >
    $( document ).ready(function() {
        ...
        ajax: {
          url: "{{ route('bank-service-charges.index') }}",
          data: function (d) {
    ...
    $("#bankServiceChargesNav").addClass('active');
   </script>
