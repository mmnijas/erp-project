@include('frontend.layouts.header')
    ...
    <section class="service-top-area" style="background-image: url('img/genericsbanner.jpg'); background-repeat: no-repeat; text-align: center;  padding: 221px 0px 69px 0px;">
        <div class="container">
        <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row flex-v-center">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                            ...
                            <div class="intro-image wow fadeIn">
                                <img src="img/business-generics.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
