@include('frontend.layouts.header')
    ...
    <section class="service-top-area" style="background-image: url('img/novalbanner.jpg'); background-repeat: no-repeat; text-align: center;  padding: 221px 0px 69px 0px;">
        <div class="container">
        <div class="row">
        <div class="col-md-12">
        <div class="ec-mini-title">
        <h1> Novel Biologics</h1>
        </div>
        ...
        <li>Businesses </li>
               ...
               <!--INFO AREA-->
            <section class="info-area gray-bg" style="background: #fafafa;">
                <div class="container">
                    <div class="row flex-v-center">
                      
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                            <div class="intro-content wow fadeInRight">       <h2> Novel  <b style="color:#0066cc">Biologics</b></h2><img src="img/lineash.png" id="linecnt">
