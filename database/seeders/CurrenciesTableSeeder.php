...
class CurrenciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => now() , "updated_at" => now() ],
            ...
            "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => now() , "updated_at" => now() ],
            ["id" => "134", "country" => "Bangladesh", "currency" => "Taka", "code" => "BDT", "symbol" => "৳", "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => now() , "updated_at" => now() ]
      ];

        Currencies::insert($data);

        Currencies::insert([
            ["country" => "Algerie", "currency" => "Algerian dinar", "code" => "DZD", "symbol" => "د.ج", "thousand_separator" => " ", "decimal_separator" => ".", "created_at" => now() , "updated_at" => now() ],
            [ "country" => "United Arab Emirates", "currency" => "United Arab Emirates dirham", "code" => "AED", "symbol" => "د.إ", "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => now() , "updated_at" => now() ],
            [ "country" => "Uganda", "currency" => "Uganda shillings", "code" => "UGX", "symbol" => "USh", "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => now() , "updated_at" => now() ],
            [ "country" => "Tanzania", "currency" => "Tanzanian shilling", "code" => "TZS", "symbol" => "TSh", "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => now() , "updated_at" => now() ],
            [ "country" => "Angola", "currency" => "Kwanza", "code" => "AOA", "symbol" => "Kz", "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => now() , "updated_at" => now() ],
            [ "country" => "Kuwait", "currency" => "Kuwaiti dinar", "code" => "KWD", "symbol" => "KD", "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => now() , "updated_at" => now() ],
            [ "country" => "Bahrain", "currency" => "Bahraini dinar", "code" => "BHD", "symbol" => "BD", "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => now() , "updated_at" => now() ]
      ]);
    }
}
